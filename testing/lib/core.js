...
(async () => {
    // i18nReady резолвиться у i18n.js після успішного fetch локалі.
    // settings.js стартує loadLanguage() ще до цього моменту —
    // тут ми просто чекаємо на його завершення.
